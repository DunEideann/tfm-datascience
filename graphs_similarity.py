...
utils.graphVariances(yMeanVariances, scenario, FIGS_PATH, vmin=0, vmax=100, extra=f'{period[0]}-{period[1]}_Mean_Percentage_{len_predictands}', extension='png', extra_title=f'Mean {extra_period}')
utils.graphVariancesMeanSd(yMeanVariances, scenario, FIGS_PATH, extra=f'{period[0]}-{period[1]}_Mean_Percentage_{len_predictands}', extension='png', extra_title=f'Mean {extra_period}')
print("2")
# 99 Quantile
y99quanVariances[scenario] = utils.getVariance(yPredLoaded[scenario], metric='99quantile', percentage=True) 
utils.graphVariances(y99quanVariances, scenario, FIGS_PATH, vmin=0, vmax=100, extra=f'{period[0]}-{period[1]}_99Quantile_Percentage_{len_predictands}', extension='png', extra_title=f'99Percentile {extra_period}')
utils.graphVariancesMeanSd(y99quanVariances, scenario, FIGS_PATH, extra=f'{period[0]}-{period[1]}_99Quantile_Percentage_{len_predictands}', extension='png', extra_title=f'99Percentile {extra_period}')
# 1 Quantile
y1quanVariances[scenario] = utils.getVariance(yPredLoaded[scenario], metric='1quantile', percentage=True) 
utils.graphVariances(y1quanVariances, scenario, FIGS_PATH, vmin=0, vmax=100, extra=f'{period[0]}-{period[1]}_1Quantile_Percentage_{len_predictands}', extension='png', extra_title=f'1Percentil {extra_period}')
utils.graphVariancesMeanSd(y1quanVariances, scenario, FIGS_PATH, extra=f'{period[0]}-{period[1]}_1Quantile_Percentage_{len_predictands}', extension='png', extra_title=f'1Percentil {extra_period}')
...
for scenario_name in scenarios:
    ...
    utils.graphVariances(yMeanVariances, scenario_name, FIGS_PATH, vmin=0, vmax=100, extra=f'Mean_Percentage_{len_predictands}', extension='png', extra_title=f'Mean {scenario_name}')
    utils.graphVariancesMeanSd(yMeanVariances, scenario_name, FIGS_PATH, extra=f'Mean_Percentage_{len_predictands}', extension='png', extra_title=f'Mean {scenario_name}')
    # 99 Quantile
    y99quanVariances[scenario_name] = utils.getVariance(yPredLoaded[scenario_name], metric='99quantile', percentage=True) 
    utils.graphVariances(y99quanVariances, scenario_name, FIGS_PATH, vmin=0, vmax=100, extra=f'99Quantile_Percentage_{len_predictands}', extension='png', extra_title=f'99Percentil {scenario_name}')
    utils.graphVariancesMeanSd(y99quanVariances, scenario_name, FIGS_PATH, extra=f'99Quantile_Percentage_{len_predictands}', extension='png', extra_title=f'99Percentil {scenario_name}')
    # 1 Quantile
    y1quanVariances[scenario_name] = utils.getVariance(yPredLoaded[scenario_name], metric='1quantile', percentage=True) 
    utils.graphVariances(y1quanVariances, scenario_name, FIGS_PATH, vmin=0, vmax=100, extra=f'1Quantile_Percentage_{len_predictands}', extension='png', extra_title=f'1Percentile {scenario_name}')
    utils.graphVariancesMeanSd(y1quanVariances, scenario_name, FIGS_PATH, extra=f'1Quantile_Percentage_{len_predictands}', extension='png', extra_title=f'1Percentile {scenario_name}')
...
utils.graphVariances(yMeanVariances, scenario_ccsignal, FIGS_PATH, vmin=0, vmax=100, extra=f'Mean_Percentage_{len_predictands}_{extra_period}', extension='png', extra_title=f'Mean {extra_period}')
utils.graphVariancesMeanSd(yMeanVariances, scenario_ccsignal, FIGS_PATH, extra=f'Mean_Percentage_{len_predictands}_{extra_period}', extension='png', extra_title=f'Mean {extra_period}')
# 99 Quantile
...
utils.graphVariances(y99quanVariances, scenario_ccsignal, FIGS_PATH, vmin=0, vmax=100, extra=f'99Quantile_Percentage_{len_predictands}_{extra_period}', extension='png', extra_title=f'99Percentil {extra_period}')
utils.graphVariancesMeanSd(y99quanVariances, scenario_ccsignal, FIGS_PATH, extra=f'99Quantile_Percentage_{len_predictands}_{extra_period}', extension='png', extra_title=f'99Percentil {extra_period}')
# 1 Quantile
...
utils.graphVariances(y1quanVariances, scenario_ccsignal, FIGS_PATH, vmin=0, vmax=100, extra=f'1Quantile_Percentage_{len_predictands}_{extra_period}', extension='png', extra_title=f'1Percentile {extra_period}')
utils.graphVariancesMeanSd(y1quanVariances, scenario_ccsignal, FIGS_PATH, extra=f'1Quantile_Percentage_{len_predictands}_{extra_period}', extension='png', extra_title=f'1Percentile {extra_period}')
