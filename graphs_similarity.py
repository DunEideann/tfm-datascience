...
utils.graphVariancesMeanSd(yMeanVariances, scenario, FIGS_PATH,  vmin=10, vmax=40, extra=f'{period[0]}-{period[1]}_Mean_Percentage_{len_predictands}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'Mean {extra_period}')
# 99 Quantile
...
utils.graphVariancesMeanSd(y99quanVariances, scenario, FIGS_PATH, vmin=15, vmax=45, extra=f'{period[0]}-{period[1]}_99Quantile_Percentage_{len_predictands}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'99Percentile {extra_period}')
# 1 Quantile
...
utils.graphVariancesMeanSd(y1quanVariances, scenario, FIGS_PATH, vmin=0, vmax=30, extra=f'{period[0]}-{period[1]}_1Quantile_Percentage_{len_predictands}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'1Percentil {extra_period}')

print("VariancesFuture Done!")
...
for scenario_name in scenarios:
    ...
    utils.graphVariancesMeanSd(yMeanVariances, scenario_name, FIGS_PATH, vmin=10, vmax=40, extra=f'Mean_Percentage_{len_predictands}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'Mean {scenario_name}')
    # 99 Quantile
    ...
    utils.graphVariancesMeanSd(y99quanVariances, scenario_name, FIGS_PATH, vmin=10, vmax=40, extra=f'99Quantile_Percentage_{len_predictands}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'99Percentil {scenario_name}')
    # 1 Quantile
    ...
    utils.graphVariancesMeanSd(y1quanVariances, scenario_name, FIGS_PATH, vmin=10, vmax=40, extra=f'1Quantile_Percentage_{len_predictands}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'1Percentile {scenario_name}')

del yPredLoaded[scenario_train], yPredLoaded[scenario_test]
print("Variances Train Done!")
...
utils.graphVariancesMeanSd(yMeanVariances, scenario_ccsignal, FIGS_PATH, vmin=0, vmax=10, extra=f'Mean_Percentage_{len_predictands}_{extra_period}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'Mean {extra_period}')
# 99 Quantile
...
utils.graphVariancesMeanSd(y99quanVariances, scenario_ccsignal, FIGS_PATH, vmin=0, vmax=10, extra=f'99Quantile_Percentage_{len_predictands}_{extra_period}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'99Percentil {extra_period}')
# 1 Quantile
...
utils.graphVariancesMeanSd(y1quanVariances, scenario_ccsignal, FIGS_PATH, vmin=0, vmax=10, extra=f'1Quantile_Percentage_{len_predictands}_{extra_period}_Quantity_{ENSEMBLE_QUANTITY}', extension='png', extra_title=f'1Percentile {extra_period}')

print("Variances CC Signal Done!")
