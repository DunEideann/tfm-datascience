...
for predictand_name in predictands:
    ...
    hist_gcm_99['mean'] = temporal_99_concat.mean('member')
...
for predictand_name in predictands:
    ...
    # Extraer los valores de 'tasmean'
    dataset_filtered = hist_gcm_mean['mean'].sel(time=slice(period_variance[0], period_variance[1]))
...
for predictand_name in predictands:
    ...
    # Extraer los valores de 'tasmean'
    dataset_filtered = hist_gcm_99['mean'].sel(time=slice(period_variance[0], period_variance[1]))
